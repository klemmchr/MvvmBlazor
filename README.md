...
The parameter will be passed before `OnInitialized` and `OnInitializedAsync` are invoked. Therefore, the parameters are available from any point
after the first lifecycle method has been invoked. You can't access them in your constructor and you're not supposed to do that either.
